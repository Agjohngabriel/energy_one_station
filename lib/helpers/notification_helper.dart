...
class NotificationHelper {
    ...
    if (data) {
      ...
      _image = (message.data['image'] != null &&
          ...
          ? message.data['image'].startsWith('http')
              ? message.data['image']
              : '${Endpoints.BASE_URL}/storage/app/public/notification/${message.data['image']}'
          : null;
    } else {
      ...
      if (GetPlatform.isAndroid) {
        _image = (message.notification?.android!.imageUrl != null &&
            ...
            ? message.notification!.android!.imageUrl!.startsWith('http')
                ...
                : '${Endpoints.BASE_URL}/storage/app/public/notification/${message.notification?.android?.imageUrl}'
            : null;
        ...
        _image = (message.notification?.apple?.imageUrl != null &&
            ...
            ? message.notification!.apple!.imageUrl!.startsWith('http')
                ...
                : '${Endpoints.BASE_URL}/storage/app/public/notification/${message.notification?.apple?.imageUrl}'
            : null;
      }
    }
  ...
  static Future<void> showTextNotification(String title, String body,
    ...
    const AndroidNotificationDetails androidPlatformChannelSpecifics =
      ...
      'Energy_one station',
      'Energy_one_station name',
      channelDescription: 'Energy_one_station description',
      playSound: true,
  ...
  static Future<void> showBigTextNotification(String title, String body,
    ...
    AndroidNotificationDetails androidPlatformChannelSpecifics =
        AndroidNotificationDetails(
      'Energy_one_delivery channel id',
      'Energy_one_delivery name',
      channelDescription: 'Energy_one_delivery description',
      importance: Importance.max,
